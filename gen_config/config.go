...
func DialHierarchy() hierarchy.HierarchyClient {
	...
	// CLIENTCRT := "../certs/hierarchy/client.crt"
	// CLIENTKEY := "../certs/hierarchy/client.key"
	// CACRT := "../certs/hierarchy/ca.crt"
...
func main() {
	...
	// Hardcoded ID from "SKF DEV CENTER GOT"
	parentID := "9d8a2eae-1ba0-4fcf-9efc-0eb75e6187db"
	config := make(Config)
