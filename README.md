...
Choosing host name on the **RPi** must follow the naming convention `functional_location-asset`, for an example, `install_team_room-cabinet`. This is done within PiBakery *Set host name to `functional_location-asset`*. The image below highlights the fields which needs to manualy configured.

![image](https://user-images.githubusercontent.com/16987380/44469154-25a05500-a627-11e8-8aa8-e07f780edbff.png)
